...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSMutableOrderedSet *orderedSet = self.imagePickerController.selectedAssetURLs;
    if ([orderedSet containsObject:url]) {
        [cell setSelected];
    }
    return cell;
}
    ...
    if (kind == UICollectionElementKindSectionFooter) {
        ...
        switch (self.filterType) {
            case QBImagePickerControllerFilterTypeNone:{
                ...
                //footerView.textLabel.text = [NSString stringWithFormat:NSLocalizedStringFromTableInBundle(format,@"QBImagePickerController",[NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"QBImagePickerController" ofType:@"bundle"]],nil),self.numberOfPhotos,self.numberOfVideos];
                break;
            }
